...
yesterday_folder = (datetime.today() - timedelta(days=2)).strftime("%m%d")

CSV_DIR = r"D:\TT用户分层"
platfrom_name = '1xspin'

# === 请求 URL ===
BASE_URL = f"https://admin-st9zepcva1e0vraronus57s.{platfrom_name}.games/user/layers"
